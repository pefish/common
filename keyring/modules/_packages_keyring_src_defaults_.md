...
*Defined in [packages/keyring/src/defaults.ts:6](https://github.com/polkadot-js/common/blob/6e4a5281/packages/keyring/src/defaults.ts#L6)*
...
*Defined in [packages/keyring/src/defaults.ts:9](https://github.com/polkadot-js/common/blob/6e4a5281/packages/keyring/src/defaults.ts#L9)*
